...
################################################################################
    ...
    echo -e "$GREEN Yiimp Ubuntu Install Script v0.2 Modified by bangdrie $COL_RESET"
    ...
    # Compil Blocknotify
    cd ~
    git clone https://github.com/bangdrie/yiimp
    ...
    echo
    echo -e "$GREEN***************************$COL_RESET"
    echo -e "$GREEN Yiimp Ubuntu Install Script v0.2 $COL_RESET"
